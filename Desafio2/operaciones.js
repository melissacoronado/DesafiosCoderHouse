...
var operaciones = function () {
    ...
    TS_CoronadoMelissa_1.default(8, 5, 'suma').then(function (retorno) { return console.log("El resultado de la Suma es: " + retorno); });
    TS_CoronadoMelissa_1.default(8, 5, 'resta').then(function (retorno) { return console.log("El resultado de la Resta es: " + retorno); });
    TS_CoronadoMelissa_1.default(6, 4, 'resta').then(function (retorno) { return console.log("El resultado de la Resta es: " + retorno); });
};
operaciones();
